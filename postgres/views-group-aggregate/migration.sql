...
-- Create Schema
CREATE SCHEMA _groupagg;

-- Create Tables
CREATE TABLE _groupagg.author (
    id serial PRIMARY KEY,
    name text NOT NULL
);

CREATE TABLE _groupagg.article (
    id serial PRIMARY KEY,
    title text NOT NULL,
    rating integer DEFAULT NULL,
    author_id integer REFERENCES _groupagg.author(id) NOT NULL
);

-- Create View
CREATE VIEW _groupagg.author_average_rating AS
  SELECT author_id, avg(rating) as average_rating
    FROM _groupagg.article
    GROUP BY author_id;

-- Insert Seed Data
INSERT INTO "_groupagg"."author" ("name") VALUES
('Coleman Spickett'),
('Gallard Dreye'),
('Alysa Beecker'),
('Kellie Owbridge'),
...
INSERT INTO "_groupagg"."article" ("author_id", "rating", "title") VALUES
